...
base_inscritos_2014_2021 <- base_inscritos_2014_2021 %>%
  filter(id_nivel_academico == "1") %>% 
  dplyr::select(nom.ins[-c(5,16)])


base_abmitidos_2014_2021 <- base_abmitidos_2014_2021 %>%
  filter(id_nivel_academico == "1") %>%
  dplyr::select(c(2,3,6,7,9,10,13,14,
                  18,20,21,23,24,29,31,32,33))


base_matriculados_2014_2021 <- base_matriculados_2014_2021 %>%
  filter(id_nivel_academico == "1") %>%
  dplyr::select(c(2,3,6,7,9,10,13,14,
                  18,20,21,23,24,29,31,32,33))


base_matriculados_pri_curs_2014_2021 <- base_matriculados_pri_curs_2014_2021 %>%
  filter(id_nivel_academico == "1") %>%
  dplyr::select(c(2,3,6,7,9,10,13,14,
                  18,20,21,23,24,29,30,31,32))


base_graduados_2000_2021 <- base_graduados_2000_2021 %>%
  filter(id_nivel_academico == "1") %>%
  dplyr::select(c(2,3,6,7,9,10,13,14,
                  18,20,21,23,24,29,31,32,33))
...
b1 <- base_inscritos_2014_2021 %>% names()
b2 <- base_abmitidos_2014_2021 %>%  names()
b3 <- base_matriculados_2014_2021 %>% names()
b4 <- base_matriculados_pri_curs_2014_2021 %>% names()
b5 <- base_graduados_2000_2021 %>%  names()
...
new.nombs <- c("code_ies", "nom_ies", "sector", "caracter",
               ...
               "nbc", "sexo", "year", "sem", "conteo")



# Renombramiento
names(base_inscritos_2014_2021) <- new.nombs
names(base_abmitidos_2014_2021) <- new.nombs
names(base_matriculados_2014_2021) <- new.nombs
names(base_matriculados_pri_curs_2014_2021) <- new.nombs
names(base_graduados_2000_2021) <- new.nombs

b1 <- base_inscritos_2014_2021
b2 <- base_abmitidos_2014_2021
b3 <- base_matriculados_2014_2021
b4 <- base_matriculados_pri_curs_2014_2021
b5 <- base_graduados_2000_2021
